...
* <span clss="bg-#FFFF90">인증 우회 (AB, Auth Bypass)</span>
...
* <span clss="bg-#FFFF90">데이터 노출 (DD, Data Disclosure)</span>
 : 타겟 시스템의 주요 데이터 절취를 목적으로 하는 방식이며, Error based, Union based, Blind based방식이 있다.

* <span clss="bg-#FFFF90">원격명령 실행 (RCE, Remote Command Excute)</span>
